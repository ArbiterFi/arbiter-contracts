...
import {TickBitmap} from "lib/v4-core/src/libraries/TickBitmap.sol";
import {Position} from "lib/v4-core/src/libraries/Position.sol";
import {UnsafeMath} from "lib/v4-core/src/libraries/UnsafeMath.sol";
...
import {SwapMath} from "lib/v4-core/src/libraries/SwapMath.sol";
import {BalanceDelta, toBalanceDelta, BalanceDeltaLibrary} from "lib/v4-core/src/types/BalanceDelta.sol";
import {Slot0} from "lib/v4-core/src/types/Slot0.sol";
import {ProtocolFeeLibrary} from "lib/v4-core/src/libraries/ProtocolFeeLibrary.sol";
import {LiquidityMath} from "lib/v4-core/src/libraries/LiquidityMath.sol";
...
library PoolExtension {
    ...
    function updateTick(
        ...
        if (liquidityGrossBefore == 0) {
            ...
            if (tick <= self.tick) {
                info.secondsPerLiquidityOutsideX128 = self.secondsPerLiquidityCumulativeX128;
            }
        }
